    ...
    >
      ...
      >
        ...
        <tbody>
          <tr className='test-row-container'>
            <td>Mean</td>
            <td>{formatStat(baseMean)}</td>
            <td>{formatStat(newMean)}</td>
            <td></td>
          </tr>
          <tr className='test-row-container'>
            <td>Median</td>
            <td>{formatStat(baseMedian)}</td>
            <td>{formatStat(newMedian)}</td>
            <td></td>
          </tr>
          <tr className='test-row-container'>
            <td>Variance</td>
            <td>{formatStat(baseVariance)}</td>
            <td>{formatStat(newVariance)}</td>
            <td></td>
          </tr>
          <tr className='test-row-container'>
            <td>Standard Deviation</td>
            <td>{formatStat(baseStandardDev)}</td>
            <td>{formatStat(newStandardDev)}</td>
            <td></td>
          </tr>
          <tr className='test-row-container'>
            <td>Min</td>
            <td>{formatStat(baseMin)}</td>
            <td>{formatStat(newMin)}</td>
            <td></td>
          </tr>
          <tr className='test-row-container' style={{ marginBottom: 2 }}>
            <td>Max</td>
            <td>{formatStat(baseMax)}</td>
            <td>{formatStat(newMax)}</td>
            <td></td>
          </tr>
