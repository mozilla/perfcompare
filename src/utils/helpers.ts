...
import type { Repository, Changeset, CompareResultsItem, MannWhitneyResultsItem } from '../types/state';
import type {
...
const studentTConfigs: CompareResultsTableConfig = [
   {
    ...
    },
    {
      ...
      matchesFunction(result: MannWhitneyResultsItem | CompareResultsItem, valueKey: string) {
        switch (valueKey) {
          case 'improvement':
