...
const getTestData = () => {
  const testData: Changeset[] = [
    ...
    {
      id: 6,
      revision: 'ed24spamspamspamspamandeggs',
      author: 'nathanniy@python.com',
      revisions: [
        {
          result_set_id: 6,
          repository_id: 77,
          revision: 'spam',
          author: 'nathanniy@python.com',
          comments: 'Bug 123456 Fuzzy She turned me into a newt!\n',
        },
        {
          result_set_id: 5,
          repository_id: 77,
          revision: 'spam',
          author: 'nathanniy@python.com',
          comments: 'Bug 2345667 Fuzzy It got better...\n',
        },
      ],
      revision_count: 1,
  ...
  const testCompareData: CompareResultsItem[] = [
    {
      ...
      base_retriggerable_job_ids: [381594973.0, 381213378.03, 381976567.97],
      new_retriggerable_job_ids: [381452501.0, 381071048.5, 381833953.5],
      base_runs: [704.84, 704.14, 705.54],
      new_runs: [712.44, 711.73, 713.15],
    ...
    },
    {
      ...
      base_measurement_unit: 'ms',
      new_measurement_unit: 'ms',
      base_retriggerable_job_ids: [381587080.0, 381205492.92, 381968667.08],
      new_retriggerable_job_ids: [381451522.0, 381070070.48, 381832973.52],
      base_runs: [776.97, 776.19, 777.75],
      new_runs: [791.34, 790.55, 792.13],
      base_runs_replicates: [],
      new_runs_replicates: [],
    ...
    },
    {
      ...
      base_measurement_unit: 'ms',
      new_measurement_unit: 'ms',
      base_retriggerable_job_ids: [381588467.0, 381206878.53, 381970055.47],
      new_retriggerable_job_ids: [381453172.0, 381071718.83, 381834625.17],
      base_runs: [643.54, 642.9, 644.18],
      new_runs: [628.09, 627.46, 628.72],
      base_runs_replicates: [],
      new_runs_replicates: [],
  ...
  const testCompareMannWhitneyData: MannWhitneyResultsItem[] = [
    {
      base_rev: 'coconut',
      new_rev: 'spam',
      base_app: '',
  ...
  const testCompareDataWithReplicates = [
    {
      ...
      base_runs: [587.15, 587.15, 587.15],
      new_runs: [605.16, 587.15, 596.15],
  ...
  const testCompareDataWithReplicatesOneValue = [
    {
      ...
      base_runs: [587.15, 586.56, 587.74],
      new_runs: [605.16, 604.55, 605.77],
      base_runs_replicates: [587.15, 593.04, 600.7, 602.04],
      new_runs_replicates: [605.16, 605.31, 605.61, 605.81, 607.27],
      base_avg_value: 595.73,
      new_avg_value: 605.83,
  ...
  const subtestsResult: CompareResultsItem[] = [
    {
      ...
      base_measurement_unit: 'ms',
      new_measurement_unit: 'ms',
      base_retriggerable_job_ids: [469521067.0, 469843701.0, 469682384.0],
      new_retriggerable_job_ids: [469707477.0, 469843700.0, 469775588.5],
      base_runs: [964.52, 978.24, 971.38],
      new_runs: [977.16, 987.66, 982.41],
    ...
    },
    {
      ...
      base_retriggerable_job_ids: [469521067.0, 469843701.0, 469682384.0],
      new_retriggerable_job_ids: [469707477.0, 469843700.0, 469775588.5],
      base_runs: [312.44, 320.26, 316.35],
      new_runs: [315.78, 323.12, 319.45],
  ...
  const mockMannWhitneyResultData: MannWhitneyResultsItem = {
    base_rev: '371a2ab12ddfc637c94e4d7883518671241283ff',
    new_rev: '371a2ab12ddfc637c94e4d7883518671241283ff',
    base_app: '',
    new_app: '',
    framework_id: 2,
    platform: 'linux64',
    suite: 'NSPR section sizes',
    header_name: 'NSPR section sizes asan asan-fuzzing ',
    base_repository_name: 'mozilla-central',
    new_repository_name: 'mozilla-central',
    is_complete: true,
    base_measurement_unit: null,
    new_measurement_unit: null,
    base_retriggerable_job_ids: [514158485.0, 513644326.51, 514672643.48],
    new_retriggerable_job_ids: [514158485.0, 513644326.51, 514672643.48],
    base_runs: [465888.0, 465422.11, 466353.89],
    new_runs: [465888.0, 465422.11, 466353.89],
    base_runs_replicates: [],
    new_runs_replicates: [],
    test: '',
    option_name: 'asan',
    extra_options: 'asan-fuzzing',
    graphs_link:
      'https://treeherder.mozilla.org/perfherder/graphs?highlightedRevisions=371a2ab12ddf&highlightedRevisions=371a2ab12ddf&series=mozilla-central%2C55b0af3d49ee1e4cab1a9337265e99c3a6c82b9b%2C1%2C2&timerange=2592000',
    delta_value: 0.0,
    ...
    base_parent_signature: null,
    new_parent_signature: null,
    base_signature_id: 1687877,
    new_signature_id: 1687877,
    has_subtests: true,
    base_standard_stats: {
      min: 465888.0,
      max: 465888.0,
  ...
  const subtestsMannWhitneyResult: MannWhitneyResultsItem[] = [
    {
      base_rev: 'd775409d7c6abb76362a3430e9880ec032ad4679',
      new_rev: '22f4cf67e8ad76b5ab2a00b97837d1d920b8c2b7',
      base_app: 'firefox',
      ...
      // Mann-Whitney specific / statistical fields
      base_standard_stats: {
        mean: 971.38,
        median: 971.38,
        stddev: 9.7,
